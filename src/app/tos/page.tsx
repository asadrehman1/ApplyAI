...
export default function Page() {
  return (
    <main className="mx-auto max-w-prose space-y-6 p-3 py-6">
      ...
      <p>
        Welcome to ApplyAI. These Terms of Service (&quot;Terms&quot;) govern
        your use of our website and services, including any paid subscription
        plans. By accessing or using AI Resume Builder (&quot;the
        Service&quot;), you agree to be bound by these Terms. If you do not
        agree to these Terms, do not use the Service.
      </p>
      <h2 className="text-xl font-semibold">1. Overview</h2>
      <p>
        ApplyAI is a SaaS platform that provides resume-building tools powered
      ...
      <ul className="list-inside list-disc">
        ...
        <li>
          <strong>Refund Policy:</strong> ApplyAI does not offer refunds for any
          payments already processed. However, you can cancel your subscription
          at any time, and you will continue to have access to the Paid Plan
      ...
      <p>
        ApplyAI grants you a limited, non-exclusive, non-transferable, and
      ...
      <p>
        ...
        ApplyAI are owned by ApplyAI or its licensors. You agree not to infringe
        on these rights.
      </p>
      <h2 className="text-xl font-semibold">10. User Content</h2>
      <p>
        By using the Service, you grant ApplyAI a non-exclusive,
      ...
      <p>
        ...
        services (e.g., Stripe for payments). ApplyAI is not
      ...
      <p>
        ...
        available&quot; basis. ApplyAI makes no warranties, express or
      ...
      <p>
        To the fullest extent permitted by law, ApplyAI shall not be
      ...
      <p>
        By using ApplyAI, you acknowledge that you have read,
